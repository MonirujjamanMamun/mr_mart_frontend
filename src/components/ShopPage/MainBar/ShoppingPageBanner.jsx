...
const ShoppingPageBanner = ({ itemsPerPageFromBanner }) => {
  ...
  return (
    <div className="w-full flex flex-col md:flex-row md:items-center justify-between">
      ...
      <div className="flex items-center gap-2 md:gap-6 mt-4 md:mt-0">
        ...
        {/*****************************
         *** Selected Part End here ***
         ******************************/}

        {/***************************************
         *** Pagination Select Part Start here ***
         *****************************************/}
      ...
      {/**************************************
       *** Pagination Select Part End here ***
       ***************************************/}
    </div>
  );
};

ShoppingPageBanner.propTypes = {
